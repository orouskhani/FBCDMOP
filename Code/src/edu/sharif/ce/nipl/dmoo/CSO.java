...
public class CSO {
	...
	public static void main(String[] args) throws Exception {
		...
		for(int cycle = 0 ; cycle < NUMCYCLE ; cycle++){
			...
			CSOBusiness buss = new CSOBusiness(nPop , nVar1 , nVar2 , minVar1 , maxVar1 , minVar2 , maxVar2 , func , cycle , towet , nt , selectionAlgo , reinitAlgo , iter);
